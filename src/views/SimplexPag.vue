                    ...
                    <div v-for="(row, i) in constraints" :key="i" class="mb-4">
                        <p class="font-semibold">
                            <span v-for="(cell, j) in row" :key="j" class="mr-2">
                                ...
                                <template v-else>
                                    ≤
                                    <input type="number" v-model.number="constraints[i][j]"
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        <thead class="table-dark">
                            <th>Var. Básica</th> <!-- Nueva columna para variables básicas -->
                            <tr>
                        ...
                        <tbody>
                            <tr v-for="(row, i) in step.table" :key="i">
                                <td class="text-center font-bold">{{ step.basic_variables[i] }}</td>
                                <!-- Mostrar la variable básica -->
